      ...
      <div>
        ...
        >
          <div class="custom_drawer__content">
            <dictItemList ref="dictItem" :dict-info.sync="showDictItemDialog.data" @queryList="queryList" @close="closeUpdate" />
          </div>
        </el-drawer>
...
import dictItemList from '../../../src/views/dictItem/dictItemList.vue'
