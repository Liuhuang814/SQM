      ...
      >
        ...
        >
          <varDictList
            ...
            :process-info.sync="processInfo"
            :bpmn-modeler.sync="bpmnModeler"
            :process-key.sync="processInfo.processKey"
          />
        </el-tab-pane>
        <el-tab-pane
          label="BPMNXML"
...
// import designLeft from './left.vue'
import designRight from './right.vue'
// import designCenter from './center.vue'
import bpmnXml from './bpmnxml.vue'
import varDictList from './varDict/varDictList.vue'
...
export default {
  ...
  beforeCreate() {
    console.log('...............diagramManager-----------------beforeCreate--------------')
  },
  created() {
    console.log('diagramManager processInfo:' + JSON.stringify(this.processInfo))
  },
  mounted() {
    ...
    renderDiagram(xml) {
      ...
      this.bpmnModeler.importXML(xml, err => {
        if (err) {
          ...
          // 调用子页面方法
          // this.$refs.panel.preHandleProcess()
        }
      })
    },
